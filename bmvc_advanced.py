...
class AttModule(nn.Module):
    def __init__(self, dilation, in_channels, out_channels, compression, args=None):
        ...
        if args.enc_norm_type == 'InstanceNorm1d':
            ...
            self.instance_norm2 = nn.InstanceNorm1d(args.num_f_maps,track_running_stats=False,affine=False)

        elif args.enc_norm_type == 'InstanceNorm1d_track':
            self.instance_norm = nn.InstanceNorm1d(in_channels,track_running_stats=True)
            self.instance_norm2 = nn.InstanceNorm1d(args.num_f_maps,track_running_stats=True)
        ...
        self.feed_forward2  = ConvFeedForward(dilation, args.num_f_maps, args.num_f_maps)
