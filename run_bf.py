...
parser.add_argument('--experiment_path', default='plots_logs/',  type=str, help='directory to save experiment results')
...
parser.add_argument('--dataset', default='breakfast', type=str)
...
parser.add_argument('--exp_name', default='alignmenr', type=str,help='name of the experiment, specifies the folder where models are saved')
...
# encoder arguments
parser.add_argument('--num_f_maps', default='40', type=int, help='feature dimension in the transformer')
...
parser.add_argument('--stage1_path', default=None, type=str, help='path to first stage root')
...
parser.add_argument('--save_seg', default=True, action='store_true', help='if we want to save segmentation plots')
...
parser.add_argument('--sigma', default=1.0, type=float, help='sigma for p_gauss')
...
num_classes =[5,7, 9, 8,5,14,8,9,12,7]
...
for emb in embs: 
    for iter in freezeiters:
        ...
        for action, classes in zip(actions, num_classes):
            ...
            args.num_f_maps= emb
            args.len_seg_max = classes+2
                    
            args.parent_dir = os.path.abspath(os.path.join(args.data_root, os.pardir))
            args.pretrained_model =f'/home/ahmed/Ahmed_data/UVAST/lambdalab machine BF/bf_logs/bf_stage2_milk_freezeiters20_emb40_ca_tot/model/breakfast/epoch-70.model'
            args.path_inference_model =f'/home/ahmed/Ahmed_data/UVAST/lambdalab machine BF/bf_logs/bf_stage2_milk_freezeiters20_emb40_ca_tot/model/breakfast/epoch-70.model'
            #args.pretrained_model ='/home/ahmed/Ahmed_data/UVAST/UVAST/logs/breakfast/bf_stage1_pancake_freezeiters0_emb40/model/breakfast/epoch-40.model'
            #args.pretrained_model ='/home/ahmed/Ahmed_data/UVAST/UVAST/logs/breakfast/bf_stage1_sandwich_freezeiters0_emb40/model/breakfast/epoch-25.model'
            
            parent_path =''
            exp_name = f'bf_{action}_video_level'
            #exp_name= 'bf_stage2_sandwich_ca_freezed'
